...
pub fn contribute(
    ...
    crate::methods::campaign::contribute::add_contribute::contribution_added(
        &env,
        &sender,
        campaign_id.clone(),
        &amount,
